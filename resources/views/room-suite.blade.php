            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 text-block pull-right animate" data-anim-type="fadeInRight" data-anim-delay="300">
                        <h1 class="yellow-text">Our room - suite</h1>
                    ...
                    <div id="carousel-example-generic" class="carousel image-gallery slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <a href="{{ BASE_URL }}/assets/images/suite-room.jpg" class="fancybox" ><img src="{{ BASE_URL }}/assets/images/suite-room.jpg" alt="image description"></a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="{{ BASE_URL }}/assets/images/suite-room.jpg" class="fancybox"><img src="{{ BASE_URL }}/assets/images/suite-room.jpg" alt="image description"></a>
                                    </div>
