                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="input-append date" id="dpd1" data-date="Check In" data-date-format="dd-mm-yyyy">
                                    <input class="form-control" name="arrive_date" size="16" type="text" value="" placeholder="Arrive Date" required>
                                    <span class="icon-calendar"></span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-append date" id="dpd2" data-date="Check Out" data-date-format="dd-mm-yyyy">
                                    <input class="form-control" name="departure_date" size="16" type="text" value="" placeholder="Depature Date" required>
                                    <span class="icon-calendar"></span>
                                </div>
                            </div>
                        </div>
