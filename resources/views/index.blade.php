                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="input-append date" id="dpd1" data-date="Check In" data-date-format="dd-mm-yyyy">
                                    <input class="form-control" name="arrive_date" size="16" type="text" value="Arrive date">
                                    <span class="icon-calendar"></span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-append date" id="dpd2" data-date="Check Out" data-date-format="dd-mm-yyyy">
                                    <input class="form-control" name="departure_date" size="16" type="text" value="Departure date">
                                    <span class="icon-calendar"></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="fake-select">
                                        ...
                                        <input class="form-control" name="guest_numbers" data-toggle="collapse" type="text" data-target="#guest-modal" value="2 Adults 1 Children" readonly style="background-color:#353535">
                                ...
                                <div class="form-group">
                                    <div class="fake-select">
                                        <select name="room_type">
                                            ...
                                            <option value="honeymoon" selected>Honeymoon Suite Room</option>
